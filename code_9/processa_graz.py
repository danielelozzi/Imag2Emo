...
def processa_e_salva_dati_graz(
    ...
    for subject_id in subject_ids:
        ...
        try:
            ...
            # Salva le label pubbliche
            # Riordina df_filtered_labels per n_progressivo_pubblico prima di estrarre le label pubbliche
            ...
            # Salva le label private
            # Riordina df_filtered_labels per n_progressivo_privato prima di estrarre le label private
